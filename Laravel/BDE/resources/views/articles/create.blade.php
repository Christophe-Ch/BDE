...
@section('content_form')
    ...
    <form action="/articles" method="POST" enctype="multipart/form-data">
        ...
        <input id="name" class="input_left" type="text" name="name" value="{{old('name')}}">

        <div id="little-input-container">
            <div class="little-input">
                <label for="price" class="title_input_left">Prix</label>
                <input id="price" class="input_left" type="text" name="price" value="{{old('price')}}">
            </div>
            <div class="little-input">
                <label for="stock" class="title_input_left">Stock</label>
                <input id="stock" class="input_left" type="text" name="stock" value="{{old('stock')}}">
            </div>
        </div>
        ...
        <textarea class="input_left" id="description-input" name="description"></textarea>
